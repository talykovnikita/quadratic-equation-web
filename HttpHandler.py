...
class HttpGetHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        # тут должна быть бизнес-логика вашего сервиса

        self._send_json_response(
            200, {"a": input_params[0], "b": input_params[1], "c": input_params[2]}
        )
    ...
    def _send_text_response(self, status_code, response_body):
        ...
        # Установка тела ответа, в данном случае обычный текст
    ...
    def _send_json_response(self, status_code, response_body):
        ...
        # Установка тела ответа, в данном случае обычный текст
        self.wfile.write(json.dumps(response_body).encode(encoding=self.charset))
